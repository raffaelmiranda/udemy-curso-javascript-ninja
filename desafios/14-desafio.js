(function () {
  ...
  */
  ...
  console.log(
    "O objeto não existe pois ele foi criado no momento da comparação; logo, é uma nova referência em memória, diferente da referência que está no objeto atribuído à numberObjects.",
  );

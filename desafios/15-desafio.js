(function () {
  ...
  var joao = new Person("João", "Santos", 25);
  var ana = new Person("Ana", "Oliveira", 28);
  console.log(maria);
  console.log(joao);
  console.log(ana);
  ...
  console.log(
    maria.getFullName() + " agora tem " + maria.addAge(5).getAge() + " anos.",
  );
  console.log(
    joao.getFullName() + " agora tem " + joao.addAge(3).getAge() + " anos.",
  );
  console.log(
    ana.getFullName() + " agora tem " + ana.addAge(2).getAge() + " anos.",
  );
})();

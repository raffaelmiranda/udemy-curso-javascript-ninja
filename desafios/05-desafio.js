...
*/
var myarray1 = [10, "Rafael", null, { a: 1 }, function () {}];
...
*/
console.log(myFunction1(myarray1)[1]);
...
*/
var myarray2 = [10, "Rafael", null, { a: 1 }, function () {}];
...
*/
var nomeLivro = "Smashing CSS";
console.log(
  "O livro " +
    nomeLivro +
    " tem " +
    livro(nomeLivro).quantidadeDePaginas +
    " páginas!",
);
...
*/
console.log(
  "O autor do livro " + nomeLivro + " é " + livro(nomeLivro).autor + ".",
);
